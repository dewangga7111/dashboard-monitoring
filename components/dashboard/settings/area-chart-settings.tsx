...
interface AreaChartSettingsPanelProps {
  settings: AreaChartSettings;
  onChange: (settings: AreaChartSettings) => void;
}
...
export default function AreaChartSettingsPanel({
  settings,
  onChange,
}: AreaChartSettingsPanelProps) {
        ...
        <div>
          ...
          <div className="flex flex-col gap-5">
            ...
            <Slider
              ...
              className="max-w-md"
              color="primary"
              value={settings.visual.gradientOpacity}
              onChange={(v) => updateSetting("visual.gradientOpacity", Number(v))}
              maxValue={1}
              minValue={0}
              showSteps={true}
              size="md"
